...
function CallToAction() {
  return (
    <form target="_blank" className='mt-6 md:hidden' action="https://monasterynft.us8.list-manage.com/subscribe/post?u=f7008c544caa2ef5d5d99950e&amp;id=bd15e4e84a" method="POST">
