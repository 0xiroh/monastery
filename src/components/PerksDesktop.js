    ...
    <div className='my-28 hidden sm:flex'>
        <ul className='grid mx-auto grid-cols-3 gap-x-28 gap-y-10'>
            <li className='flex-col w-[15vw]'>
                <i class="text-white fa-solid fa-key mr-44"></i>    
            ...
            <li className='flex-col w-[15vw]'>
                <i class="text-white fa-solid fa-bag-shopping mr-44"></i>    
            ...
            <li className='flex-col w-[15vw]'>
                <i class="text-white fa-solid fa-globe mr-44"></i>    
            ...
            <li className='flex-col w-[15vw]'>
                <i class="text-white fa-solid fa-map mr-44"></i>    
            ...
            <li className='flex-col w-[15vw]'>
                <i class="text-white fa-solid fa-pen-nib mr-44"></i>    
