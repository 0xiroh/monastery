...
function CollectionRMA() {
  return (
    <>
        <div className='grid my-16 justify-center items-center sm:grid sm:grid-cols-2 sm:gap-3'>
            <div className='row-span-2 mx-auto order-2 sm:order-1'>
                <a href="https://rmadesign.tv">

                <img src="images/rma2.png" className='sm:ml-40 sm:w-[25vw]'/>
                </a>
            ...
            <h1 className='text-white text-4xl font-extrabold mb-10 sm:my-0'>About the collection</h1>
            <p className='text-white text-justify w-72 sm:w-[16vw] mx-auto pt-4' >The GYATSO NFT is going to be our genesis collection. The art you are receiving, specially designed by MST and RMA, it will unlock all the perks mentioned here and more.</p>
            </div>
            <div className='flex mt-12 sm:mt-0 flex-col order-3 justify-center items-center'>
                <h1 className='text-white text-4xl block text-center font-extrabold myb-10 sm:my-0'>About<br/>RMA</h1>
                <p className='text-white text-justify w-72 sm:w-[20vw] mx-auto pt-4'>
