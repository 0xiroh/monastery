...
function HeroDesktop() {
  return (
      <div className='hidden w-[95vw] items-center justify-around md:flex'>
        <div className='flex-col w-[40%]'>
            <h1 className=' leading-tight mt-14 font-extrabold  text-[5rem] text-white text-left'>
                Monastery <br/>Gyatso NFT<br/> Collection
            </h1>
            <p className='text-white mt-4 text-left'>Our most Iconic Cap will be sold as an NFT </p>
            <form className='mt-6 flex w-full'>
                <input className='text-left pl-4 w-[60%] block mr-6' type='email' id='email' name='email' placeholder='Enter your email' />
